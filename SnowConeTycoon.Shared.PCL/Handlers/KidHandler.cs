...
namespace SnowConeTycoon.Shared.Handlers
{
    public static class KidHandler
    {
        ...
        public static void Init()
        {
            ...
            Boys.Add("Boy3", new Kid("Chad", "BoyAvatar_02", "Eyes_Open1"));
            Boys.Add("Boy4", new Kid("Jake", "BoyAvatar_04", "Eyes_Open4", true, UnlockMechanism.Purchase, 20));
            Boys.Add("Boy5", new Kid("Victor", "BoyAvatar_22", "Eyes_Open3"));
            Boys.Add("Boy6", new Kid("Trevor", "BoyAvatar_30", "Eyes_Open4"));
            Boys.Add("Boy7", new Kid("Greyson", "BoyAvatar_26", "Eyes_Open2"));
            Boys.Add("Boy8", new Kid("Tommy", "BoyAvatar_08", "Eyes_Open6", true, UnlockMechanism.Purchase, 250));
            Boys.Add("Boy9", new Kid("Jon", "BoyAvatar_15", "Eyes_Open3"));
            Boys.Add("Boy10", new Kid("Bailey", "BoyAvatar_10", "Eyes_Open7"));
            Boys.Add("Boy11", new Kid("Braiden", "BoyAvatar_11", "Eyes_Open6"));
            Boys.Add("Boy12", new Kid("Eric", "BoyAvatar_14", "Eyes_Open1"));
            Boys.Add("Boy13", new Kid("Thomas", "BoyAvatar_33", "Eyes_Open5"));
            Boys.Add("Boy14", new Kid("Marshall", "BoyAvatar_20", "Eyes_Open6"));
            Boys.Add("Boy15", new Kid("Kyle", "BoyAvatar_09", "Eyes_Open3"));
            Boys.Add("Boy16", new Kid("Sam", "BoyAvatar_03", "Eyes_Open2", true, UnlockMechanism.Purchase, 15));
            ...
            Boys.Add("Boy20", new Kid("Shawn", "BoyAvatar_12", "Eyes_Open5"));
            Boys.Add("Boy21", new Kid("Allen", "BoyAvatar_21", "Eyes_Open7"));
            Boys.Add("Boy22", new Kid("Jay", "BoyAvatar_01", "Eyes_Open3"));
            ...
            Boys.Add("Boy26", new Kid("Craig", "BoyAvatar_07", "Eyes_Open5", true, UnlockMechanism.Purchase, 25));
            ...
            Boys.Add("Boy33", new Kid("Ronald", "BoyAvatar_13", "Eyes_Open2"));
            ...
            Girls.Add("Girl4", new Kid("London", "GirlAvatar_04", "Eyes_Open6", true, UnlockMechanism.Purchase, 100));
            Girls.Add("Girl5", new Kid("Navea", "GirlAvatar_18", "Eyes_Open7"));
            Girls.Add("Girl6", new Kid("Kaley", "GirlAvatar_26", "Eyes_Open4"));
            Girls.Add("Girl7", new Kid("Beelz", "GirlAvatar_31", "Eyes_Open3"));
            Girls.Add("Girl8", new Kid("Abby", "GirlAvatar_08", "Eyes_Open7"));
            Girls.Add("Girl9", new Kid("Anita", "GirlAvatar_09", "Eyes_Open2"));
            Girls.Add("Girl10", new Kid("Gloria", "GirlAvatar_22", "Eyes_Open4"));
            Girls.Add("Girl11", new Kid("Mary", "GirlAvatar_11", "Eyes_Open3"));
            Girls.Add("Girl12", new Kid("Penelope", "GirlAvatar_25", "Eyes_Open2"));
            Girls.Add("Girl13", new Kid("Clara", "GirlAvatar_02", "Eyes_Open3", true, UnlockMechanism.Purchase, 100));
            Girls.Add("Girl14", new Kid("Angie", "GirlAvatar_14", "Eyes_Open3"));
            Girls.Add("Girl15", new Kid("Lyla", "GirlAvatar_35", "Eyes_Open3"));
            Girls.Add("Girl16", new Kid("Abigail", "GirlAvatar_16", "Eyes_Open7"));
            Girls.Add("Girl17", new Kid("Samantha", "GirlAvatar_36", "Eyes_Open3"));
            Girls.Add("Girl18", new Kid("Jenny", "GirlAvatar_05", "Eyes_Open2", true, UnlockMechanism.Purchase, 100));
            Girls.Add("Girl19", new Kid("Queen Ella", "GirlAvatar_30", "Eyes_Open2"));
            Girls.Add("Girl20", new Kid("Ellee", "GirlAvatar_33", "Eyes_Open3"));
            Girls.Add("Girl21", new Kid("Rebecca", "GirlAvatar_21", "Eyes_Open3"));
            Girls.Add("Girl22", new Kid("Marilyn", "GirlAvatar_06", "Eyes_Open4", true, UnlockMechanism.Purchase, 100));
            Girls.Add("Girl23", new Kid("Hannah", "GirlAvatar_23", "Eyes_Open3"));
            Girls.Add("Girl24", new Kid("Miranda", "GirlAvatar_24", "Eyes_Open1"));
            Girls.Add("Girl25", new Kid("Jamie", "GirlAvatar_12", "Eyes_Open4"));
            Girls.Add("Girl26", new Kid("Lucy", "GirlAvatar_10", "Eyes_Open1"));
            ...
            Girls.Add("Girl30", new Kid("Tina", "GirlAvatar_19", "Eyes_Open3"));
            Girls.Add("Girl31", new Kid("Gabby", "GirlAvatar_07", "Eyes_Open3"));
            Girls.Add("Girl32", new Kid("Isabelle", "GirlAvatar_32", "Eyes_Open2"));
            Girls.Add("Girl33", new Kid("Donna", "GirlAvatar_20", "Eyes_Open1"));
            Girls.Add("Girl34", new Kid("Ana", "GirlAvatar_34", "Eyes_Open7"));
            Girls.Add("Girl35", new Kid("Tasha", "GirlAvatar_13", "Eyes_Open5"));
            Girls.Add("Girl36", new Kid("Lara", "GirlAvatar_17", "Eyes_Open2"));
